...
def combat_calc(enem, posi): #, mob_size to add if necessary
    ...
    enem.rps(plat.pattack(posi))
    enem.hp = enem.hp - (plat.dmg + enem.res)
    plat.hp = plat.hp - (enem.dmg + plat.res)
    health = [plat.hp, enem.hp]
    return health